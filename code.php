...
$code['root'] = dirname(__FILE__).'/files/'; // full path, with trailing slash ##
if ( $_SESSION['live'] == 0 ) { // running locally ##
    $code['root'] = dirname(__FILE__).'/files/'; // local path -- for testing ##     
} 
$code['domain_cookie'] = ".weiyu.me"; // domain name ##
...
$code['name'] = "Php Tester"; // system name ##
